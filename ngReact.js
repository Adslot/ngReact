...
(function (root, factory) {
  ...
  function renderComponent(component, props, scope, reactRoot) {
  ...
  var reactComponent = function ($injector) {
    return {
      ...
      link: function (scope, elem, attrs) {
        ...
        const reactRoot = ReactDOMClient.createRoot(elem[0]);

        var renderMyComponent = function () {
          var scopeProps = scope.$eval(attrs.props);
          var props = applyFunctions(scopeProps, scope);

          renderComponent(reactComponent, props, scope, reactRoot);
        };
        ...
        scope.$on('$destroy', function () {
          if (!attrs.onScopeDestroy) {
            ...
            scope.$eval(attrs.onScopeDestroy, {
              unmount: reactRoot.unmount.bind(this),
            });
          }
        });
      },
      ...
      var directive = {
        ...
        link: function (scope, elem, attrs) {
          ...
          var renderMyComponent = function () {
            ...
            renderComponent(reactComponent, scopeProps, scope, reactRoot);
          };
